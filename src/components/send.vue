<template>
<div class="container">
  <form action="/post" enctype="multipart/form-data" method="post" @submit.prevent="submit($event)" accept-charset="UTF-8">
  ...
  <div class="send">
    ...
    <div style="position:relative">
          ...
          <input type="button" value="上传照片" class="btn btn-default" style="color:#EC69AB; border:1.5px solid #EC69AB;height:48px;width:142px;font-size:20px;border-radius:30px;position:absolute;bottom:0;margin-left:22%;font-weight:bold" @click.stop="load">
    ...
    <div style="height:30px;width:100%;"></div>
        <div style="height:1px;width:953px;border:1px solid #f7f7f7;margin-left:100px;"></div>
          ...
          <input type="text" class="form-control" style="height:50px; width:400px;border-color:#666666;font-size:28px; margin-left:23.5%;"  placeholder="请输入标题" name="title">
        </div>
        <div style="height:30px;width:100%;"></div>
        <div style="height:1px;width:953px;border:1px solid #f7f7f7;margin-left:100px;"></div>
        <div style="height:30px;width:100%;"></div>
        ...
        <textarea name="content" id="" style="height:349px;width:400px;border: 1px solid #666666;font-size:16px; margin-left:17%" placeholder="请输入正文内容"></textarea>
    </div>
